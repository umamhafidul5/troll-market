...
//                .antMatchers("/account/**", "/api/**").permitAll()
                .antMatchers("/home/**", "/shipment/**", "/admin/**", "/history/**").hasAuthority("Admin")
                .antMatchers("/home/**", "/profile/**", "/shop/**", "/myCart/**").hasAuthority("Buyer")
                .antMatchers("/home/**", "/profile/**", "/merchandise/**").hasAuthority("Seller")
